...
> الحالة: الدروس 1، 2، 3 كاملة بتمارينها ✅ (الكود على GitHub)

## نسق النشر: ادفع dev فقط بعد كل جلسة (لا build). main يُدمج عند التجميعة فقط (build واحد) — توفيراً لدقائق Netlify (~76% متبقية حتى 22 جوان).
