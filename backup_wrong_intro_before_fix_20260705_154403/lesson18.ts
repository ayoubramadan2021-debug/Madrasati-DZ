export const LESSON_18_CONTENT = {
  ...
  scenes: [
    ...
    },
    {
      ...
      text: "أُنْظُرُوا إِلَى الطِّفْلِ. القِطُّ عَنْ يَمِينِهِ، وَالكَلْبُ عَنْ يَسَارِهِ.",
    },
    {
      scene_image: "/lessons/v2/lesson18-position/s3.webp",
      audio_key: "s3_above_below",
      text: "أُنْظُرُوا إِلَى الطَّاوِلَةِ. الكِتَابُ فَوْقَ الطَّاوِلَةِ، وَالكُرَةُ تَحْتَ الطَّاوِلَةِ.",
    },
    {
      scene_image: "/lessons/v2/lesson18-position/s4.webp",
      audio_key: "s4_front_behind",
      text: "أُنْظُرُوا إِلَى الكُرْسِيِّ. الطِّفْلُ أَمَامَ الكُرْسِيِّ، وَالحَقِيبَةُ خَلْفَ الكُرْسِيِّ.",
    },
    {
      scene_image: "/lessons/v2/lesson18-position/s5.webp",
      audio_key: "s5_inside_outside",
      text: "أُنْظُرُوا إِلَى الصُّنْدُوقِ. الكُرَةُ دَاخِلَ الصُّنْدُوقِ، وَالدُّمْيَةُ خَارِجَ الصُّنْدُوقِ.",
    },
    {
