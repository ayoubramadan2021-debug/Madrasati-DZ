...
".pd-root{min-height:100dvh;background:#07101f;font-family:'Tajawal',sans-serif;direction:rtl;overflow-x:hidden;position:relative;padding-bottom:100px}",
...
".pd-back{position:absolute;top:20px;right:16px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.8);border-radius:12px;padding:8px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Tajawal',sans-serif}",
...
".pd-logo-bg{position:absolute;inset:0;border-radius:24px;background:linear-gradient(145deg,#1a3d73,#0c1e3a);border:1px solid rgba(232,160,32,.4);box-shadow:0 8px 32px rgba(0,0,0,.5)}",
".pd-logo-em{position:relative;font-size:40px}",
".pd-title{font-size:23px;font-weight:900;line-height:1;margin-bottom:6px;background:linear-gradient(135deg,#fff 25%,#E8A020 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}",
".pd-sub{font-size:13px;color:rgba(255,255,255,.4)}",
".pd-body{padding:0 16px}",
".pd-state{text-align:center;padding:50px 20px;color:rgba(255,255,255,.45);font-size:15px}",
".pd-card{background:linear-gradient(135deg,rgba(15,25,45,.97),rgba(10,16,30,.99));border:1px solid rgba(255,255,255,.09);border-radius:18px;padding:20px;margin-bottom:16px;box-shadow:0 8px 28px rgba(0,0,0,.4)}",
".pd-name{font-size:18px;font-weight:800;color:#fff;margin-bottom:4px}",
".pd-gradeline{font-size:13px;color:rgba(255,255,255,.5);margin-bottom:16px}",
".pd-grid3{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:18px}",
".pd-stat{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:14px;padding:14px 8px;text-align:center}",
".pd-stat-em{font-size:28px;margin-bottom:5px}",
".pd-stat-n{font-size:22px;font-weight:900;color:#E8A020;line-height:1}",
".pd-stat-l{font-size:11px;color:rgba(255,255,255,.5);margin-top:4px}",
".pd-sec{font-size:15px;font-weight:800;color:#E8A020;margin-bottom:10px}",
".pd-empty{font-size:13px;color:rgba(255,255,255,.4)}",
...
".pd-act-id{font-size:13px;font-weight:600;color:rgba(255,255,255,.85)}",
".pd-act-pts{font-size:13px;font-weight:700;color:#4ade80}",
".pd-deny{min-height:100dvh;background:#07101f;color:#fff;display:grid;place-items:center;text-align:center;padding:30px;font-family:'Tajawal',sans-serif;direction:rtl}",
].join("\n");
...
function ParentDashboardPage() {
  ...
  if (authorized === null) {
    return <div className="pd-deny" style={{ color: "#E8A020" }}>... جاري التحقق</div>;
  }
  if (authorized === false) {
    return (
