...
".lb-root{min-height:100dvh;background:#07101f;font-family:'Tajawal',sans-serif;direction:rtl;overflow-x:hidden;position:relative;padding-bottom:100px}",
...
".lb-back{position:absolute;top:20px;right:16px;display:inline-flex;align-items:center;gap:6px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.8);border-radius:12px;padding:8px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Tajawal',sans-serif;transition:background .2s}",
...
".lb-logo-bg{position:absolute;inset:0;border-radius:26px;background:linear-gradient(145deg,#1a3d73,#0c1e3a);border:1px solid rgba(232,160,32,.4);box-shadow:0 8px 32px rgba(0,0,0,.5),inset 0 1px 0 rgba(255,255,255,.08)}",
...
".lb-title{font-size:28px;font-weight:900;line-height:1;margin-bottom:6px;background:linear-gradient(135deg,#fff 25%,#E8A020 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;opacity:0;transform:translateY(14px);transition:opacity .6s ease .2s,transform .6s ease .2s}",
".lb-title.in{opacity:1;transform:translateY(0)}",
".lb-sub{font-size:13px;color:rgba(255,255,255,.4);opacity:0;transition:opacity .6s ease .35s}",
".lb-sub.in{opacity:1}",
".lb-body{padding:0 16px}",
".lb-state{text-align:center;padding:50px 20px;color:rgba(255,255,255,.5);font-size:15px}",
...
".lb-pcard{position:relative;border-radius:18px;padding:14px 10px;overflow:hidden;background:linear-gradient(135deg,rgba(15,25,45,.96),rgba(10,16,30,.98))}",
".lb-pcard-glow{position:absolute;inset:0;opacity:.5}",
".lb-pav{position:relative;font-size:26px}",
".lb-pname{position:relative;font-weight:800;color:#fff;font-size:13px;margin-top:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
...
".lb-iname{font-weight:700;color:#fff;font-size:14px}",
".lb-igrade{color:rgba(255,255,255,.4);font-size:12px;margin-top:2px}",
".lb-ipts{font-weight:900;color:#E8A020;font-size:15px;flex-shrink:0}",
".lb-me-badge{display:inline-block;font-size:10px;font-weight:800;color:#000;background:#E8A020;border-radius:6px;padding:1px 7px;margin-right:6px}",
".lb-empty{text-align:center;padding:40px;color:rgba(255,255,255,.4)}",
...
export default function LeaderboardPage() {
  ...
  const podium = [
    ...
    { idx: 0, medal: "🥇", color: "#E8A020", flex: 1.25, delay: "0.25s", pt: 26 },
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      background: isMe ? "linear-gradient(135deg,rgba(232,160,32,.16),rgba(201,125,10,.08))" : "linear-gradient(135deg,rgba(15,25,45,.96),rgba(10,16,30,.98))",
                  ...
                  >
                    <div className="lb-rank" style={{ background: "rgba(255,255,255,.06)", color: "rgba(255,255,255,.6)" }}>{i + 4}</div>
