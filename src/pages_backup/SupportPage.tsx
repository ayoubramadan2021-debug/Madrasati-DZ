...
".sp-root{min-height:100dvh;background:#07101f;font-family:'Tajawal',sans-serif;direction:rtl;overflow-x:hidden;position:relative;padding-bottom:100px}",
...
".sp-back{position:absolute;top:20px;right:16px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.8);border-radius:12px;padding:8px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Tajawal',sans-serif;transition:background .2s}",
...
".sp-logo-bg{position:absolute;inset:0;border-radius:22px;background:linear-gradient(145deg,#1a3d73,#0c1e3a);border:1px solid rgba(232,160,32,.4);box-shadow:0 8px 32px rgba(0,0,0,.5)}",
".sp-logo-em{position:relative;font-size:38px;filter:drop-shadow(0 0 14px rgba(232,160,32,.6))}",
".sp-title{font-size:24px;font-weight:900;line-height:1;margin-bottom:6px;background:linear-gradient(135deg,#fff 25%,#E8A020 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}",
".sp-sub{font-size:13px;color:rgba(255,255,255,.4)}",
".sp-body{padding:0 16px}",
".sp-sec{display:flex;align-items:center;gap:8px;margin:8px 0 12px}",
".sp-sec-bar{width:4px;height:20px;border-radius:4px;background:linear-gradient(180deg,#E8A020,#c97d0a)}",
".sp-sec-t{font-size:17px;font-weight:800;color:#fff}",
".sp-faq{background:linear-gradient(135deg,rgba(15,25,45,.96),rgba(10,16,30,.98));border:1px solid rgba(255,255,255,.08);border-radius:16px;padding:16px;margin-bottom:10px;box-shadow:0 4px 16px rgba(0,0,0,.3)}",
".sp-faq-q{font-weight:700;color:#E8A020;font-size:14px;margin-bottom:6px}",
".sp-faq-a{color:rgba(255,255,255,.55);font-size:13px;line-height:1.7}",
".sp-card{background:linear-gradient(135deg,rgba(15,25,45,.97),rgba(10,16,30,.99));border:1px solid rgba(255,255,255,.09);border-radius:18px;padding:20px;box-shadow:0 8px 28px rgba(0,0,0,.4)}",
".sp-label{font-size:13px;font-weight:700;color:rgba(255,255,255,.7);display:block;margin-bottom:8px}",
".sp-textarea{width:100%;padding:13px 16px;border-radius:12px;border:1.5px solid rgba(255,255,255,.1);background:rgba(255,255,255,.04);color:#fff;font-family:'Tajawal',sans-serif;font-size:14px;resize:vertical;outline:none;direction:rtl;line-height:1.7;transition:border-color .2s}",
".sp-textarea:focus{border-color:rgba(232,160,32,.5)}",
".sp-textarea::placeholder{color:rgba(255,255,255,.3)}",
...
".sp-success-d{color:rgba(255,255,255,.5);font-size:14px;margin-bottom:20px}",
".sp-again{padding:12px 24px;border:none;border-radius:12px;background:linear-gradient(135deg,#22C55E,#16a34a);color:#fff;font-family:'Tajawal',sans-serif;font-size:14px;font-weight:700;cursor:pointer;transition:transform .15s}",
              ...
              <>
                ...
                <div className="sp-card">
                  ...
                  <button
                    ...
                    style={{
                      background: msg.trim() ? "linear-gradient(135deg,#E8A020,#c97d0a)" : "rgba(255,255,255,.1)",
                      color: msg.trim() ? "#000" : "rgba(255,255,255,.4)",
