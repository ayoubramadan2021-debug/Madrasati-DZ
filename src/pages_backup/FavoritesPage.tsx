...
".fv-root{min-height:100dvh;background:#07101f;font-family:'Tajawal',sans-serif;direction:rtl;overflow-x:hidden;position:relative;padding-bottom:100px}",
...
".fv-back{position:absolute;top:20px;right:16px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.8);border-radius:12px;padding:8px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Tajawal',sans-serif;transition:background .2s}",
".fv-back:active{background:rgba(255,255,255,.12)}",
...
".fv-logo-bg{position:absolute;inset:0;border-radius:24px;background:linear-gradient(145deg,#1a3d73,#0c1e3a);border:1px solid rgba(232,160,32,.4);box-shadow:0 8px 32px rgba(0,0,0,.5)}",
...
".fv-title{font-size:26px;font-weight:900;line-height:1;margin-bottom:6px;background:linear-gradient(135deg,#fff 25%,#E8A020 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;opacity:0;transform:translateY(14px);transition:opacity .6s ease .2s,transform .6s ease .2s}",
".fv-title.in{opacity:1;transform:translateY(0)}",
".fv-sub{font-size:13px;color:rgba(255,255,255,.4);opacity:0;transition:opacity .6s ease .35s}",
".fv-sub.in{opacity:1}",
".fv-body{padding:0 16px}",
".fv-state{text-align:center;padding:50px 20px;color:rgba(255,255,255,.5);font-size:15px}",
".fv-empty{text-align:center;padding:40px 20px;color:rgba(255,255,255,.4)}",
".fv-empty-em{font-size:48px;margin-bottom:10px}",
".fv-empty-btn{margin-top:16px;padding:12px 26px;border:none;border-radius:13px;background:linear-gradient(135deg,#E8A020,#c97d0a);color:#000;font-family:'Tajawal',sans-serif;font-size:14px;font-weight:800;cursor:pointer;box-shadow:0 4px 14px rgba(232,160,32,.3);transition:transform .15s}",
".fv-empty-btn:active{transform:scale(.96)}",
".fv-list{display:flex;flex-direction:column;gap:10px}",
".fv-item{position:relative;background:linear-gradient(135deg,rgba(15,25,45,.96),rgba(10,16,30,.98));border:1px solid rgba(255,255,255,.08);border-radius:16px;padding:14px 16px;display:flex;align-items:center;gap:14px;box-shadow:0 4px 18px rgba(0,0,0,.3);overflow:hidden;animation:fv-slide .5s ease backwards}",
"@keyframes fv-slide{from{opacity:0;transform:translateX(30px)}to{opacity:1;transform:translateX(0)}}",
".fv-item-strip{position:absolute;right:0;top:0;bottom:0;width:4px;border-radius:0 16px 16px 0;background:linear-gradient(180deg,#E8A020,#c97d0a)}",
...
".fv-item-t{font-weight:700;color:#fff;font-size:15px}",
".fv-item-d{color:rgba(255,255,255,.4);font-size:12px;margin-top:2px}",
