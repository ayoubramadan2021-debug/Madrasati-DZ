...
const FALLBACK = ["#22C55E","#EF4444","#3B82F6","#A855F7","#F97316","#06B6D4","#E8A020","#1B3A6B"];
const FALLBACK_GLOW = ["#16a34a","#dc2626","#2563eb","#9333ea","#ea580c","#0891b2","#c97d0a","#0f2444"];

const CSS = [
"@import url('https://fonts.googleapis.com/css2?family=Tajawal:wght@300;400;500;700;800;900&display=swap');",
".gr-root *,.gr-root *::before,.gr-root *::after{box-sizing:border-box;margin:0;padding:0}",
".gr-root{min-height:100dvh;background:#07101f;font-family:'Tajawal',sans-serif;direction:rtl;overflow-x:hidden;position:relative;padding-bottom:100px}",
...
".gr-back{position:absolute;top:20px;right:16px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.8);border-radius:12px;padding:8px 14px;font-size:13px;font-weight:700;text-decoration:none;transition:background .2s}",
".gr-back:active{background:rgba(255,255,255,.12)}",
...
".gr-logo-bg{position:absolute;inset:0;border-radius:26px;background:linear-gradient(145deg,#1a3d73,#0c1e3a);border:1px solid rgba(232,160,32,.4);box-shadow:0 8px 32px rgba(0,0,0,.5),inset 0 1px 0 rgba(255,255,255,.08)}",
...
".gr-title{font-size:28px;font-weight:900;line-height:1;margin-bottom:6px;background:linear-gradient(135deg,#fff 25%,#E8A020 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;opacity:0;transform:translateY(14px);transition:opacity .6s ease .2s,transform .6s ease .2s}",
".gr-title.in{opacity:1;transform:translateY(0)}",
".gr-sub{font-size:13px;color:rgba(255,255,255,.4);opacity:0;transition:opacity .6s ease .35s}",
".gr-sub.in{opacity:1}",
...
".gr-card-bg{position:absolute;inset:0;background:linear-gradient(135deg,rgba(15,25,45,.96),rgba(10,16,30,.98));border:1px solid rgba(255,255,255,.08);border-radius:20px}",
...
".gr-nm{font-size:18px;font-weight:800;color:#fff;display:block;margin-bottom:3px}",
".gr-ds{font-size:12px;color:rgba(255,255,255,.4)}",
".gr-ar{width:36px;height:36px;border-radius:11px;background:rgba(255,255,255,.05);display:grid;place-items:center;flex-shrink:0;font-size:16px;color:rgba(255,255,255,.4)}",
].join("\n");
