...
".ex-root{min-height:100dvh;background:#07101f;font-family:'Tajawal',sans-serif;direction:rtl;overflow-x:hidden;position:relative;padding-bottom:100px}",
...
".ex-back{position:absolute;top:20px;right:16px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.8);border-radius:12px;padding:8px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Tajawal',sans-serif;transition:background .2s}",
...
".ex-logo-bg{position:absolute;inset:0;border-radius:24px;background:linear-gradient(145deg,#1a3d73,#0c1e3a);border:1px solid rgba(232,160,32,.4);box-shadow:0 8px 32px rgba(0,0,0,.5)}",
".ex-logo-em{position:relative;font-size:38px;filter:drop-shadow(0 0 14px rgba(232,160,32,.6))}",
".ex-title{font-size:24px;font-weight:900;line-height:1;margin-bottom:6px;background:linear-gradient(135deg,#fff 25%,#E8A020 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}",
".ex-sub{font-size:13px;color:rgba(255,255,255,.4)}",
".ex-body{padding:0 16px}",
".ex-score{border-radius:20px;padding:24px;text-align:center;color:#fff;margin-bottom:16px;animation:ex-pop .5s ease}",
...
".ex-retry{margin-top:14px;padding:10px 22px;border-radius:12px;border:none;background:rgba(255,255,255,.2);color:#fff;font-family:'Tajawal',sans-serif;font-weight:700;cursor:pointer;transition:transform .15s}",
".ex-retry:active{transform:scale(.95)}",
".ex-q{background:linear-gradient(135deg,rgba(15,25,45,.96),rgba(10,16,30,.98));border-radius:18px;padding:18px;margin-bottom:14px;box-shadow:0 6px 22px rgba(0,0,0,.3);transition:border-color .3s}",
".ex-q-head{display:flex;gap:10px;margin-bottom:14px;align-items:flex-start}",
".ex-q-num{width:30px;height:30px;border-radius:50%;background:linear-gradient(135deg,#E8A020,#c97d0a);color:#000;display:grid;place-items:center;font-weight:800;font-size:13px;flex-shrink:0}",
".ex-q-txt{font-weight:700;color:#fff;font-size:15px;line-height:1.6;padding-top:3px}",
...
".ex-correct-btn{margin-top:12px;width:100%;padding:11px;border:none;border-radius:12px;background:linear-gradient(135deg,#3B82F6,#2563eb);color:#fff;font-family:'Tajawal',sans-serif;font-weight:700;font-size:14px;cursor:pointer;transition:transform .15s}",
".ex-correct-btn:active{transform:scale(.97)}",
".ex-finish{width:100%;padding:15px;border-radius:16px;border:none;background:linear-gradient(135deg,#E8A020,#c97d0a);color:#000;font-family:'Tajawal',sans-serif;font-weight:800;font-size:16px;cursor:pointer;box-shadow:0 6px 18px rgba(232,160,32,.35);transition:transform .15s}",
".ex-finish:active{transform:scale(.97)}",
".ex-empty{text-align:center;padding:50px 20px;color:rgba(255,255,255,.4)}",
        ...
        <div className="ex-content">
          ...
          <div className="ex-body">
            ...
            {questions.map((q: any, idx: number) => {
              ...
              const border = answered ? (results[idx] ? "1.5px solid rgba(34,197,94,.5)" : "1.5px solid rgba(239,68,68,.5)") : "1px solid rgba(255,255,255,.08)";
              return (
                  ...
                  <div className="ex-opts">
                    {(q.options || []).map((opt: string) => {
                      ...
                      if (answered && isCorrect) {
                        ...
                        bg = "rgba(232,160,32,.12)"; bd = "1.5px solid #E8A020"; col = "#E8A020";
                      }
