...
".au-root{min-height:100dvh;background:#07101f;font-family:'Tajawal',sans-serif;direction:rtl;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:20px;position:relative;overflow:hidden}",
...
".au-logo-bg{position:absolute;inset:0;border-radius:24px;background:linear-gradient(145deg,#1a3d73,#0c1e3a);border:1px solid rgba(232,160,32,.4);box-shadow:0 8px 32px rgba(0,0,0,.5),inset 0 1px 0 rgba(255,255,255,.08)}",
...
".au-title{font-size:38px;font-weight:900;line-height:1;background:linear-gradient(135deg,#fff 25%,#E8A020 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}",
".au-tag{color:rgba(255,255,255,.45);font-size:13px;margin-top:6px}",
".au-card{position:relative;z-index:2;background:linear-gradient(135deg,rgba(15,25,45,.97),rgba(10,16,30,.99));border:1px solid rgba(255,255,255,.09);border-radius:24px;padding:26px;width:100%;max-width:400px;box-shadow:0 20px 60px rgba(0,0,0,.5);opacity:0;transform:translateY(20px);transition:opacity .6s ease .2s,transform .6s ease .2s}",
".au-card.in{opacity:1;transform:translateY(0)}",
".au-tabs{display:grid;grid-template-columns:1fr 1fr;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:4px;margin-bottom:22px}",
".au-tab{padding:11px;border:none;border-radius:11px;background:transparent;color:rgba(255,255,255,.45);font-family:'Tajawal',sans-serif;font-size:14px;font-weight:700;cursor:pointer;transition:all .25s}",
".au-tab.active{background:linear-gradient(135deg,#E8A020,#c97d0a);color:#000;box-shadow:0 4px 12px rgba(232,160,32,.3)}",
".au-label{font-size:13px;font-weight:700;color:rgba(255,255,255,.7);display:block;margin-bottom:6px}",
".au-field{width:100%;padding:13px 16px;border-radius:12px;border:1.5px solid rgba(255,255,255,.1);background:rgba(255,255,255,.04);color:#fff;font-family:'Tajawal',sans-serif;font-size:14px;outline:none;margin-bottom:14px;transition:border-color .2s}",
".au-field::placeholder{color:rgba(255,255,255,.3)}",
...
".au-submit{width:100%;padding:15px;border:none;border-radius:14px;background:linear-gradient(135deg,#E8A020,#c97d0a);color:#000;font-family:'Tajawal',sans-serif;font-size:16px;font-weight:800;cursor:pointer;box-shadow:0 6px 18px rgba(232,160,32,.35);transition:transform .15s}",
".au-submit:active{transform:scale(.97)}",
".au-submit:disabled{opacity:.6;cursor:default}",
".au-ghost{width:100%;margin-top:12px;padding:13px;border:1.5px solid rgba(255,255,255,.12);border-radius:14px;background:transparent;color:rgba(255,255,255,.55);font-family:'Tajawal',sans-serif;font-size:14px;cursor:pointer;transition:background .2s}",
".au-ghost:active{background:rgba(255,255,255,.05)}",
].join("\n");
