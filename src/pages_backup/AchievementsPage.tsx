...
".ac-root{min-height:100dvh;background:#07101f;font-family:'Tajawal',sans-serif;direction:rtl;overflow-x:hidden;position:relative;padding-bottom:100px}",
...
".ac-logo-bg{position:absolute;inset:0;border-radius:24px;background:linear-gradient(145deg,#1a3d73,#0c1e3a);border:1px solid rgba(232,160,32,.4);box-shadow:0 8px 32px rgba(0,0,0,.5)}",
...
".ac-title{font-size:24px;font-weight:900;line-height:1;margin-bottom:6px;background:linear-gradient(135deg,#fff 25%,#E8A020 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}",
".ac-sub{font-size:13px;color:rgba(255,255,255,.4)}",
".ac-body{padding:0 16px}",
".ac-state{text-align:center;padding:50px 20px;color:rgba(255,255,255,.45);font-size:15px}",
".ac-summary{background:linear-gradient(135deg,rgba(15,25,45,.97),rgba(10,16,30,.99));border:1px solid rgba(255,255,255,.09);border-radius:20px;padding:20px;margin-bottom:18px;box-shadow:0 8px 28px rgba(0,0,0,.4)}",
".ac-greet{font-size:18px;font-weight:800;color:#fff;margin-bottom:6px}",
".ac-count{font-size:13px;color:rgba(255,255,255,.5);margin-bottom:14px}",
".ac-count b{color:#E8A020}",
".ac-bar{width:100%;height:14px;border-radius:999px;background:rgba(255,255,255,.07);overflow:hidden}",
".ac-bar-f{height:100%;border-radius:999px;background:linear-gradient(90deg,#E8A020,#c97d0a);box-shadow:0 0 12px rgba(232,160,32,.5);transition:width .9s cubic-bezier(.34,1.2,.64,1)}",
...
".ac-badge-t{font-size:16px;font-weight:800;color:#fff;margin-bottom:4px}",
".ac-badge-d{font-size:12px;color:rgba(255,255,255,.5);line-height:1.6;margin-bottom:8px}",
                  ...
                  {badges.map((badge, i) => (
                    <div
                      ...
                      style={{
                        ...
                        background: badge.unlocked ? "linear-gradient(135deg,rgba(34,197,94,.1),rgba(16,163,74,.04))" : "linear-gradient(135deg,rgba(15,25,45,.96),rgba(10,16,30,.98))",
                    ...
                    >
                      ...
                      <div className="ac-badge-body">
                        ...
                        <div className="ac-badge-s" style={{ color: badge.unlocked ? "#4ade80" : "rgba(255,255,255,.4)" }}>
