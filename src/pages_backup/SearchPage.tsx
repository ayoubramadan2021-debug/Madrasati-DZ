...
".se-root{min-height:100dvh;background:#07101f;font-family:'Tajawal',sans-serif;direction:rtl;overflow-x:hidden;position:relative;padding-bottom:100px}",
...
".se-logo-bg{position:absolute;inset:0;border-radius:22px;background:linear-gradient(145deg,#1a3d73,#0c1e3a);border:1px solid rgba(232,160,32,.4);box-shadow:0 8px 32px rgba(0,0,0,.5)}",
".se-logo-em{position:relative;font-size:36px;filter:drop-shadow(0 0 14px rgba(232,160,32,.6))}",
".se-title{font-size:24px;font-weight:900;line-height:1;margin-bottom:6px;background:linear-gradient(135deg,#fff 25%,#E8A020 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}",
".se-sub{font-size:13px;color:rgba(255,255,255,.4)}",
".se-search-wrap{padding:0 16px;margin-bottom:18px}",
".se-search{width:100%;padding:15px 18px;border-radius:16px;border:1.5px solid rgba(255,255,255,.1);background:rgba(255,255,255,.04);color:#fff;font-family:'Tajawal',sans-serif;font-size:15px;outline:none;transition:border-color .2s}",
".se-search::placeholder{color:rgba(255,255,255,.35)}",
".se-search:focus{border-color:rgba(232,160,32,.5)}",
".se-body{padding:0 16px}",
".se-state{text-align:center;padding:40px 20px;color:rgba(255,255,255,.45);font-size:14px}",
...
".se-sec-c{margin-right:auto;background:rgba(255,255,255,.06);color:rgba(255,255,255,.6);border-radius:20px;padding:2px 12px;font-size:12px;font-weight:700}",
".se-item{display:block;text-decoration:none;position:relative;background:linear-gradient(135deg,rgba(15,25,45,.96),rgba(10,16,30,.98));border:1px solid rgba(255,255,255,.08);border-radius:14px;padding:14px 16px;margin-bottom:10px;overflow:hidden;animation:se-slide .4s ease backwards;transition:transform .2s}",
...
".se-item-t{font-weight:700;color:#fff;font-size:14px;margin-bottom:3px}",
".se-item-d{color:rgba(255,255,255,.45);font-size:12px;line-height:1.5}",
].join("\n");
          ...
          <div className="se-body">
            {loading ? (
              ...
              <>
                ...
                {/* التمارين */}
                <div className="se-sec">
                  <div className="se-sec-bar" style={{ background: "linear-gradient(180deg,#E8A020,#c97d0a)" }} />
                ...
                {filteredExercises.length === 0 ? (
                  ...
                  filteredExercises.map((exercise, i) => (
                    <Link
                      ...
                      style={{ animationDelay: (i * 0.05) + "s" }}
                    >
                      <div className="se-item-strip" style={{ background: "linear-gradient(180deg,#E8A020,#c97d0a)" }} />
