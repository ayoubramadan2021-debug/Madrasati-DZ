    ...
    <main dir="rtl" style={styles.page}>
      ...
      <section style={styles.card}>
        ...
        <div style={styles.badgesRow}>
          <div style={styles.smallBadge}>⭐ ممتاز</div>
          <div style={styles.smallBadge}>🎯 مكتمل</div>
          <div style={styles.smallBadge}>🏆 بطل</div>
        </div>
        ...
        <div style={styles.progressBox}>
          <div style={styles.progressText}>أَتْمَمْتَ التَّمَارِينَ بِنَجَاحٍ</div>
        ...
        <div style={styles.actions}>
          ...
          >
            الرُّجُوعُ إِلَى الرَّئِيسِيَّة 🏠
          </button>
        </div>
      </section>
    </main>
...
const styles: Record<string, React.CSSProperties> = {
  page: {
    ...
    width: "100%",
    background:
      "radial-gradient(circle at top,#FFF7D6 0%,#FFE8A3 42%,#FFF8EC 100%)",
    fontFamily: "Tajawal, sans-serif",
    direction: "rtl",
    display: "flex",
    alignItems: "stretch",
  ...
  card: {
    ...
    position: "relative",
    background:
      "linear-gradient(180deg,rgba(255,255,255,.98),rgba(255,248,236,.96))",
    border: "none",
    borderRadius: 0,
