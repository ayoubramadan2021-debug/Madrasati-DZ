...
Record<string, ArabicSemanticHighlight[]> = {
  s1: [{ text: "قَسَمًا بِالنَّازِلَاتِ الْمَاحِقَاتِ، وَالدِّمَاءِ الزَّاكِيَاتِ الطَّاهِرَاتِ، وَالْبُنُودِ اللَّامِعَاتِ الْخَافِقَاتِ، فِي الْجِبَالِ الشَّامِخَاتِ الشَّاهِقَاتِ، نَحْنُ ثُرْنَا فَحَيَاةٌ أَوْ مَمَاتٌ، وَعَقَدْنَا الْعَزْمَ أَنْ تَحْيَا الْجَزَائِرُ، فَاشْهَدُوا.. فَاشْهَدُوا.. فَاشْهَدُوا..", color: "blue" }, { text: "بِاحْتِرَامٍ", color: "blue" }, { text: "الْجَزَائِرِ", color: "green" }],
  s2: [{ text: "النَّشِيدِ", color: "blue" }, { text: "الْوَطَنِيِّ", color: "blue" }, { text: "بِاحْتِرَامٍ", color: "blue" }, { text: "عَلَمِ", color: "blue" }],
  s3: [{ text: "قَسَمًا بِالنَّازِلَاتِ الْمَاحِقَاتِ، وَالدِّمَاءِ الزَّاكِيَاتِ الطَّاهِرَاتِ، وَالْبُنُودِ اللَّامِعَاتِ الْخَافِقَاتِ، فِي الْجِبَالِ الشَّامِخَاتِ الشَّاهِقَاتِ، نَحْنُ ثُرْنَا فَحَيَاةٌ أَوْ مَمَاتٌ، وَعَقَدْنَا الْعَزْمَ أَنْ تَحْيَا الْجَزَائِرُ، فَاشْهَدُوا.. فَاشْهَدُوا.. فَاشْهَدُوا..", color: "blue" }, { text: "الْمَاحِقَاتِ", color: "blue" }, { text: "الزَّاكِيَاتِ", color: "green" }, { text: "الطَّاهِرَاتِ", color: "green" }, { text: "الْخَافِقَاتِ", color: "blue" }, { text: "الشَّاهِقَاتِ", color: "blue" }, { text: "الْجَزَائِرُ", color: "green" }, { text: "فَاشْهَدُوا", color: "blue" }],
...
const lesson10 = {
  ...
  slides: [
    ...
    },
    {
      scene: 3,
      is_anthem_card: true,
      scene_image: "/lessons/v2/arabic/lesson10/s3.webp?v=1789743137",
      ...
      anthem_title: "قسما",
      anthem_verses: [
        { first: "قسما بِالنَّازِلَاتِ الْمَاحِقَاتِ،", second: "وَالدِّمَاءِ الزَّاكِيَاتِ الطَّاهِرَاتِ." },
