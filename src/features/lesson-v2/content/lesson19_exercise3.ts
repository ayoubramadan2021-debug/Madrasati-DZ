...
export const LESSON_19_EXERCISE_3: RankOrderItem[] = [
  {
    ...
    question: "مَا صِنْفُ الحَلِيبِ؟",
    mode: "pickRank",
    correct: "مِنْ صِنْفِ الحَلِيبِ وَمُشْتَقَّاتِهِ",
    options: ["الحُبُوبُ", "مِنْ صِنْفِ اللُّحُومِ", "مِنْ صِنْفِ الحَلِيبِ وَمُشْتَقَّاتِهِ", "مِنْ صِنْفِ الخُضَرِ"],
  },
  {
    scene_image: "/lessons/v2/lesson19-food/s4.webp",
    ...
    question: "مَا صِنْفُ الجُبْنِ؟",
    mode: "pickRank",
    correct: "مِنْ صِنْفِ الحَلِيبِ وَمُشْتَقَّاتِهِ",
    options: ["مِنْ صِنْفِ الحَلِيبِ وَمُشْتَقَّاتِهِ", "مِنْ صِنْفِ الفَوَاكِهِ", "مِنْ صِنْفِ الأَسْمَاكِ", "الحُبُوبُ"],
  },
  {
    scene_image: "/lessons/v2/lesson19-food/s4.webp",
