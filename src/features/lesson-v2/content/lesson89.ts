export const lesson89CanonicalText = {
  ...
  lesson89_s5: "لِنُجَرِّبْ مَعَ أَعْدَادٍ أُخْرَى: سِتَّةٌ زَائِدَ ثَمَانِيَةٍ، وَسَبْعَةٌ زَائِدَ ثَمَانِيَةٍ، وَسِتَّةٌ زَائِدَ سَبْعَةٍ. نَخْتَارُ فِي كُلِّ مَرَّةٍ الطَّرِيقَةَ الْأَسْهَلَ.",
