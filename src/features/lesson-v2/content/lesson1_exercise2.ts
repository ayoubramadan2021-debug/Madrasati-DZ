...
export const LESSON_1_EXERCISE_2: CountTapItem[] = [
  ...
  {
    target_number: 1,
    question: "اِخْتَرِ الْمَجْمُوعَةَ الَّتِي بِهَا مَوْزَةٌ وَاحِدَةٌ",
  ...
  {
    target_number: 2,
    question: "أَيْنَ تُوجَدُ مَوْزَتَانِ اِثْنَتَانِ؟",
  ...
  {
    target_number: 3,
    question: "اِخْتَرِ الصُّورَةَ الَّتِي بِهَا ثَلَاثُ مَوْزَاتٍ",
  ...
  {
    target_number: 4,
    question: "أَيْنَ نَرَى أَرْبَعَ مَوْزَاتٍ؟",
  ...
  {
    target_number: 5,
    question: "اِبْحَثْ عَنْ خَمْسِ مَوْزَاتٍ",
