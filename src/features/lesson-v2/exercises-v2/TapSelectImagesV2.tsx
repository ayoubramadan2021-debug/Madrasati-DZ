...
// عكس TapSelectWordsV2: يعرض كلمة في السؤال + 4 صور للاختيار
// ═══════════════════════════════════════════════════════════════

export type TapSelectImageItem = {
  question: string;
...
export default function TapSelectImagesV2({
  items,
  audio_base,
  ...
  return (
    <div style={{
      ...
      <div style={{
        position: "absolute", inset: 0,
        background: "linear-gradient(180deg, rgba(255,248,236,0.85) 0%, rgba(247,219,160,0.95) 100%)",
        pointerEvents: "none",
      }} />
