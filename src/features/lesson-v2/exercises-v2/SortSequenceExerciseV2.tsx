...
export default function SortSequenceExerciseV2({
  ...
  const handleDragEnd = (e: DragEndEvent) => {
    ...
    if (isCorrect && !placements[slotIdx]) {
      ...
      setTimeout(() => setWrongSlot(null), 1200);
    }
  };
  ...
  const coachText =
    feedbackState === "complete"
      ? "رائع يا بطل! رتّبتَ العناصر بشكل صحيح 🎉"
      : wrongSlot !== null
        ? "اقتربت! فكّر في مكان هذا العنصر 👏"
        : question.direction === "asc"
          ? "ابدأ من الأصغر ثم الأكبر 🔢"
          : "ابدأ من الأكبر ثم الأصغر 🔢";
  ...
  return (
    <div style={{
      ...
      {(feedbackState === "complete" || wrongSlot !== null) && (
        <div style={{
          position: "fixed",
          left: 18,
          right: 18,
