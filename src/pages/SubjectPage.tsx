...
const SECTIONS = [
  ...
  { slug: "quizzes",   icon: "📝", name: "الاختبارات",     desc: "اختبارات قصيرة لقياس الفهم",   color: "var(--gold)", glow: "var(--gold-deep)" },
...
".sb-back{position:absolute;top:20px;right:16px;background:var(--border-faint);border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.8);border-radius:12px;padding:8px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Tajawal',sans-serif;transition:background .2s}",
...
".sb-card-bg{position:absolute;inset:0;background:var(--surface-2);border:1px solid var(--border-soft);border-radius:20px}",
...
".sb-card-d{font-size:11px;color:var(--text-faint);line-height:1.5}",
].join("\n");
