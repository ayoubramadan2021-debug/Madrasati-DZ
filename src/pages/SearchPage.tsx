...
".se-search{width:100%;padding:15px 18px;border-radius:16px;border:1.5px solid rgba(255,255,255,.1);background:var(--surface-softer);color:var(--text);font-family:'Tajawal',sans-serif;font-size:15px;outline:none;transition:border-color .2s}",
...
".se-sec-c{margin-right:auto;background:var(--border-faint);color:rgba(255,255,255,.6);border-radius:20px;padding:2px 12px;font-size:12px;font-weight:700}",
