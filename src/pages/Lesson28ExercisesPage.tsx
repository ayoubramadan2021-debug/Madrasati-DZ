...
import {
  LESSON_28_EXERCISE_1,
  LESSON_28_EXERCISE_AUDIO_BASE,
} from "../features/lesson-v2/content/lesson28_exercise1";
import { LESSON_28_EXERCISE_2 } from "../features/lesson-v2/content/lesson28_exercise2";
import { LESSON_28_EXERCISE_3 } from "../features/lesson-v2/content/lesson28_exercise3";
import { LESSON_28_EXERCISE_4 } from "../features/lesson-v2/content/lesson28_exercise4";
...
export default function Lesson28ExercisesPage() {
  ...
  if (stage === "ex1") {
    content = (
      <EquationBuilderV2
        key="lesson28-ex1"
        items={LESSON_28_EXERCISE_1}
        audio_base={LESSON_28_EXERCISE_AUDIO_BASE}
