...
import {
  LESSON_29_EXERCISE_1,
  LESSON_29_EXERCISE_AUDIO_BASE,
} from "../features/lesson-v2/content/lesson29_exercise1";

import {
  LESSON_29_EXERCISE_2,
} from "../features/lesson-v2/content/lesson29_exercise2";

import {
  LESSON_29_EXERCISE_3,
} from "../features/lesson-v2/content/lesson29_exercise3";

import {
  LESSON_29_EXERCISE_4,
} from "../features/lesson-v2/content/lesson29_exercise4";
...
export default function Lesson29ExercisesPage() {
  ...
  if (stage === "ex1") {
    content = (
      <AddSubStoryLabV2
        key="lesson29-ex1"
        items={LESSON_29_EXERCISE_1}
        audio_base={LESSON_29_EXERCISE_AUDIO_BASE}
