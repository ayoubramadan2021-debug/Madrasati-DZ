...
".pa-root{min-height:100dvh;background:var(--bg);font-family:'Tajawal',sans-serif;direction:rtl;overflow-x:hidden;position:relative;padding-bottom:100px}",
...
".pa-back{position:absolute;top:20px;right:16px;background:var(--border-faint);border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.8);border-radius:12px;padding:8px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Tajawal',sans-serif}",
...
".pa-logo-bg{position:absolute;inset:0;border-radius:24px;background:linear-gradient(145deg,#1a3d73,#0c1e3a);border:1px solid rgba(232,160,32,.4);box-shadow:var(--shadow-strong)}",
".pa-logo-em{position:relative;font-size:40px}",
".pa-title{font-size:23px;font-weight:900;line-height:1;margin-bottom:6px;background:linear-gradient(135deg,#fff 25%,var(--gold) 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}",
".pa-sub{font-size:13px;color:var(--text-faint)}",
".pa-body{padding:0 16px}",
".pa-state{text-align:center;padding:50px 20px;color:var(--text-faint);font-size:15px}",
".pa-card{background:var(--surface);border:1px solid var(--border);border-radius:18px;padding:20px;margin-bottom:16px;box-shadow:var(--shadow-hero)}",
".pa-card-t{font-size:17px;font-weight:800;color:var(--gold);margin-bottom:12px}",
".pa-info{font-size:14px;color:rgba(255,255,255,.65);line-height:2}",
".pa-info b{color:var(--text);font-weight:700}",
".pa-grid3{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:16px}",
".pa-stat{background:var(--surface-softer);border:1px solid var(--border-soft);border-radius:16px;padding:16px 8px;text-align:center}",
".pa-stat-em{font-size:30px;margin-bottom:6px}",
".pa-stat-n{font-size:24px;font-weight:900;color:var(--gold);line-height:1}",
".pa-stat-l{font-size:11px;color:var(--text-muted);margin-top:5px}",
".pa-label{display:block;margin-bottom:8px;color:rgba(255,255,255,.7);font-weight:700;font-size:13px}",
".pa-input{width:100%;padding:13px 16px;border-radius:12px;border:1.5px solid rgba(255,255,255,.1);background:var(--surface-softer);color:var(--text);font-family:'Tajawal',sans-serif;font-size:14px;outline:none;direction:rtl}",
...
".pa-msg{margin-top:14px;padding:13px;border-radius:12px;text-align:center;font-size:14px;font-weight:600;background:var(--surface-soft);border:1px solid rgba(255,255,255,.1);color:#fff}",
