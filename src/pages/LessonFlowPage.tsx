...
".lf-input{width:100%;padding:13px 16px;border-radius:12px;border:1.5px solid rgba(255,255,255,.1);background:var(--surface-softer);color:var(--text);font-family:'Tajawal',sans-serif;font-size:14px;outline:none;direction:rtl;transition:border-color .2s}",
".lf-input:focus{border-color:rgba(232,160,32,.5)}",
".lf-opt{display:block;padding:12px 14px;border-radius:12px;margin-bottom:8px;background:var(--surface-softer);border:1.5px solid rgba(255,255,255,.1);color:rgba(255,255,255,.85);font-size:14px;cursor:pointer;transition:all .2s}",
