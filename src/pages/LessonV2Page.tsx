...
export default function LessonV2Page() {
  ...
  const handleDone = () => {
    ...
    if (lessonId) {
      lessonId === "lesson2" ? navigate("/lesson2-exercises") : lessonId === "lesson3" ? navigate("/lesson3-exercises") : lessonId === "lesson4" ? navigate("/lesson4-exercises") : lessonId === "lesson5" ? navigate("/lesson5-exercises") : lessonId === "lesson5" ? navigate("/lesson5-exercises") : navigate(`/lesson-v2/${lessonId}/exercises`);
    } else {
