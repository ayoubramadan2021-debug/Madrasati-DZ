...
const navigate = useNavigate();
  ...
  const handleDone = () => {
    lessonId === "lesson2" ? navigate("/lesson2-exercises")
      ...
      : lessonId === "lesson12" ? navigate("/lesson-v2/lesson12/exercises")
      : lessonId === "lesson13" ? navigate("/lesson-v2/lesson13/exercises")
      : lessonId === "lesson14" ? navigate("/lesson-v2/lesson14/exercises")
      : lessonId === "lesson15" ? navigate("/lesson-v2/lesson15/exercises")
      : lessonId === "lesson16" ? navigate("/lesson-v2/lesson16/exercises")
      : lessonId === "lesson17" ? navigate("/lesson-v2/lesson17/exercises")
      : lessonId === "lesson18" ? navigate("/lesson-v2/lesson18/exercises")
      : lessonId === "lesson19" ? navigate("/lesson-v2/lesson19/exercises")
      : lessonId === "lesson20" ? navigate("/lesson-v2/lesson20/exercises")
