...
".carrow{width:38px;height:38px;border-radius:12px;background:var(--surface-soft);display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:17px;color:rgba(255,255,255,.35);transition:background .25s,color .25s,transform .25s cubic-bezier(.34,1.56,.64,1)}",
".card.act .carrow{background:rgba(255,255,255,.12);color:var(--text);transform:translateX(-5px)}",
...
".cta-btn{padding:9px 16px;background:linear-gradient(135deg,var(--gold),var(--gold-deep));border-radius:12px;font-size:12px;font-weight:800;color:#000;white-space:nowrap;box-shadow:0 4px 16px rgba(232,160,32,.35),0 0 0 1px rgba(255,255,255,.1) inset;cursor:pointer;border:none;font-family:'Tajawal',sans-serif;transition:transform .2s,box-shadow .2s}",
".cta-btn:active{transform:scale(.96)}",
".hd-actions{position:absolute;top:18px;left:16px;display:flex;gap:10px;z-index:5}",
".hd-btn{position:relative;width:44px;height:44px;border-radius:14px;background:var(--border-faint);border:1px solid rgba(255,255,255,.1);display:grid;place-items:center;font-size:20px;cursor:pointer;transition:background .2s,transform .15s}",
