...
import {
  LESSON_24_EXERCISE_2,
  LESSON_24_EXERCISE_2_AUDIO_BASE,
} from "../features/lesson-v2/content/lesson24_exercise2";
import {
...
export default function Lesson24ExercisesPage() {
  ...
  if (stage === "ex2") {
    return (
      <PathJourneyExerciseV2
        key="lesson24-point"
        items={LESSON_24_EXERCISE_2}
        audio_base={LESSON_24_EXERCISE_2_AUDIO_BASE}
