...
ITEMS = [
    ("w1_intro_1",
     "فِي صَبَاحٍ جَمِيلٍ... يَذْهَبُ فَاضِلْ وَسِيرِينْ وَرَحْمَة إِلَى الْمَدْرَسَةِ لِأَوَّلِ مَرَّة",
     "taline"),

    ("w1_intro_2",
     "يَكْتَشِفُونَ سَاحَةَ الْمَدْرَسَةِ الْكَبِيرَةَ... وَيَلْتَقُونَ زُمَلَاءَهُمْ الْجُدُد",
     "khalil"),

    ("w1_intro_3a",
     "مَرْحَبًا بِكُمْ يَا أَعِزَّائِي! أَنَا الْأُسْتَاذَةُ تَالِين",
     "taline"),
    ...
    ("w1_intro_5_q",
     "يَا عَزِيزِي... مَاذَا يَفْعَلُ التِّلْمِيذُ الْجَدِيدْ عِنْدَ دُخُولِهْ الْقِسْم؟",
     "taline"),
