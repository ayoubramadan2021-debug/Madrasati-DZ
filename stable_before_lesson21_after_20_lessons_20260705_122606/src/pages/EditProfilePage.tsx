...
".ep-back{position:absolute;top:20px;right:16px;background:var(--border-faint);border:1px solid var(--border);color:var(--text);border-radius:12px;padding:8px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Tajawal',sans-serif;transition:background .2s}",
".ep-back:active{background:var(--border-soft)}",
...
".ep-label{display:block;margin-top:14px;margin-bottom:7px;color:var(--text-muted);font-weight:700;font-size:13px}",
".ep-label:first-child{margin-top:0}",
".ep-input{width:100%;padding:13px 16px;border-radius:12px;border:1.5px solid var(--border);background:var(--surface-softer);color:var(--text);font-family:'Tajawal',sans-serif;font-size:14px;outline:none;transition:border-color .2s}",
...
".ep-msg{margin-top:16px;padding:13px;border-radius:12px;text-align:center;font-size:14px;font-weight:600;background:var(--surface-soft);border:1px solid var(--border);color:#fff}",
].join("\n");
