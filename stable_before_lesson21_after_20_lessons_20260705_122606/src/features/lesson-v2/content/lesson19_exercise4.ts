...
export const LESSON_19_EXERCISE_4: RankOrderItem[] = [
  {
    ...
    question: "مَا صِنْفُ الخُبْزِ؟",
    mode: "pickRank",
    correct: "الحُبُوبُ",
    options: ["اللُّحُومُ", "الحُبُوبُ", "الفَوَاكِهُ", "الحَلِيبُ"],
  },
  {
    scene_image: "/lessons/v2/lesson19-food/s5.webp",
    ...
    question: "مَا صِنْفُ الأَرُزِّ؟",
    mode: "pickRank",
    correct: "الحُبُوبُ",
    options: ["الحَلِيبُ", "الخُضَرُ", "الأَسْمَاكُ", "الحُبُوبُ"],
  },
  {
    scene_image: "/lessons/v2/lesson19-food/s5.webp",
