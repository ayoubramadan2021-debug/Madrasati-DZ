...
".card{position:relative;border-radius:var(--radius-lg);overflow:hidden;cursor:pointer;opacity:0;transform:translateX(50px) scale(.95);transition:opacity .55s cubic-bezier(.34,1.2,.64,1),transform .55s cubic-bezier(.34,1.2,.64,1),box-shadow .3s ease}",
".card.in{opacity:1;transform:translateX(0) scale(1)}",
".card:active{transform:scale(.97)!important}",
".cbg{position:absolute;inset:0;background:var(--surface-2);border:1px solid rgba(255,255,255,.07);border-radius:var(--radius-lg);transition:border-color .3s ease}",
...
".cglow{position:absolute;inset:0;border-radius:var(--radius-lg);opacity:0;pointer-events:none;transition:opacity .35s ease}",
".card.act .cglow{opacity:1}",
".cshim{position:absolute;inset:0;border-radius:var(--radius-lg);background:linear-gradient(110deg,transparent 35%,rgba(255,255,255,.045) 50%,transparent 65%);opacity:0;pointer-events:none;transition:opacity .3s ease}",
